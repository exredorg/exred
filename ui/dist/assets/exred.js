...
define("exred/templates/components/x-info-tab", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "3wuofdBS", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"layout-row flex\"],[7],[0,\"\\n  \"],[6,\"h2\"],[7],[1,[20,[\"state\",\"activeNode\",\"visibleName\"]],false],[8],[0,\"\\n  \"],[6,\"span\"],[9,\"class\",\"flex\"],[7],[8],[0,\"\\n\"],[4,\"if\",[[20,[\"state\",\"activeNode\"]]],null,{\"statements\":[[0,\"    \"],[4,\"paper-button\",null,[[\"iconButton\",\"onClick\"],[true,[25,\"action\",[[19,0,[]],[20,[\"deleteActive\"]]],null]]],{\"statements\":[[1,[25,\"paper-icon\",[\"delete\"],null],false]],\"parameters\":[]},null],[0,\"\\n\"]],\"parameters\":[]},null],[8],[0,\"\\n\"],[1,[25,\"markdown-to-html\",[[20,[\"state\",\"activeNode\",\"info\"]]],null],false],[0,\"\\n\\n\"],[1,[25,\"x-json\",null,[[\"value\"],[[20,[\"state\",\"activeNode\"]]]]],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "exred/templates/components/x-info-tab.hbs" } });
});
...
if (typeof FastBoot === 'undefined') {
  if (!runningTests) {
    require('exred/app')['default'].create({"LOG_RESOLVER":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"exred","version":"0.0.0+f03f9852"});
  }
}
