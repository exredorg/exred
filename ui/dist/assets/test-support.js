...
define("@ember/test-helpers/teardown-application-context", ["exports"], function (exports) {
  "use strict";
...
define('ember-frost-core/test-support/frost-link', ['exports', 'ember'], function (exports, _ember) {
  exports.stubRoutingService = stubRoutingService;
  ...
  function stubRoutingService(context) {
    var RouterStub = _ember['default'].Object.extend({
      generateURL: function generateURL(endpoint, segments) {
        var url = endpoint;
