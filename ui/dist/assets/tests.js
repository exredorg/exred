...
define('exred/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/diagram-node.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/diagram-node.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/x-config-tab/list-multiselect.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/x-config-tab/list-multiselect.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/x-json.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/x-json.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/x-jsplumb.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/x-jsplumb.js should pass ESLint\n\n');
  });
