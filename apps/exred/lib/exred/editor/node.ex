defmodule Exred.Editor.Node do
  use Ecto.Schema
  import Ecto.Changeset
  alias Exred.Editor.Node
  ...
  schema "nodes" do
    ...
    has_many :in_conns, Exred.Editor.Connection, foreign_key: :target_id
    has_many :out_conns, Exred.Editor.Connection, foreign_key: :source_id
